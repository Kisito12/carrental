...
<div class="container">
    ...
    <div class="car-list">
        <div class="car-item">
            <div class="car-name">Luxury Sedan</div>
            <div class="car-price">$50/day</div>
        </div>
        <div class="car-item">
            <div class="car-name">Family SUV</div>
            <div class="car-price">$70/day</div>
        </div>
        <div class="car-item">
            <div class="car-name">Sports Car</div>
            <div class="car-price">$150/day</div>
        </div>
        <div class="car-item">
            <div class="car-name">Hatchback</div>
            <div class="car-price">$250/day</div>
        </div>
        <div class="car-item">
            <div class="car-name">Pickup Truck</div>
            <div class="car-price">$150/day</div>
        </div>
        <div class="car-item">
