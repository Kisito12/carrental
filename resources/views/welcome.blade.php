...
<body class="font-nunito">
    ...
    {{-- Navbar --}}
    {{-- Hero --}}
    <section class="bg-white py-8 antialiased dark:bg-gray-900 md:py-20">
        <div class="mx-auto grid max-w-screen-xl px-4 pb-8 md:grid-cols-12 lg:gap-12 lg:pb-16 xl:gap-0">
            <div class="content-center justify-self-start md:col-span-7 md:text-start">
                <h1
                    ...
                    Your <span class="text-brand-500">Fast & Reliable</span> Car Rental Service</h1>
                <p class="mb-4 max-w-2xl text-gray-500 dark:text-gray-400 md:mb-12 md:text-lg lg:mb-5 lg:text-xl">Don't
                    Find the best cars at the best prices, anytime, anywhere.</p>
                <a href="#cars"
                    class="inline-block rounded-lg bg-brand-700 px-6 py-3.5 text-center font-medium text-white hover:bg-brand-800 focus:outline-none focus:ring-4 focus:ring-brand-300 dark:bg-brand-600 dark:hover:bg-brand-700 dark:focus:ring-brand-800">Book
                    Now</a>
            </div>
            <div class="hidden md:col-span-5 md:mt-0 md:flex">
                <img class="dark:hidden" src="{{ asset('assets/images/cars/hero.jpg') }}" alt="shopping illustration" />
                <img class="hidden dark:block" src="{{ asset('assets/images/cars/hero.jpg') }}"
    ...
    <section id="features" class="bg-white dark:bg-gray-900">
        <div class="py-8 px-4 mx-auto max-w-screen-xl sm:py-16 lg:px-6">
            ...
            <div class="space-y-8 md:grid md:grid-cols-2 lg:grid-cols-3 md:gap-12 md:space-y-0">
                <div>
                    <div
                        class="flex justify-center items-center mb-4 w-10 h-10 rounded-full bg-brand-100 lg:h-12 lg:w-12 dark:bg-brand-900">
                        <svg class="w-5 h-5 text-brand-600 lg:w-6 lg:h-6 dark:text-brand-300" fill="currentColor"
    ...
    {{-- Cars --}}
    <section id="cars" class="bg-gray-50 py-8 antialiased dark:bg-gray-900 md:py-12">
                        ...
                        <div class="pt-6">
                            <div class="mb-4 flex items-center justify-between gap-4">
                                <span
                                    ...
                                    {{ $car->brand }} - {{ $car->year }}</span>
                            </div>

                            <a href="{{ route('book.index', $car->id) }}"
                                class="text-lg font-semibold leading-tight text-gray-900 hover:underline dark:text-white">{{ $car->name }}</a>
                            ...
                            <div class="mt-4 flex flex-col text-left gap-4">
                                <p class="text-2xl font-extrabold leading-tight text-gray-900 dark:text-white">
                                    {{ number_format($car->price_per_day, 0) }} FCFA/day
                                </p>

                                <a href="{{ route('book.index', $car->id) }}"
                                    class="inline-flex text-center justify-center items-center rounded-lg bg-brand-700 px-5 py-2.5 text-sm font-medium text-white hover:bg-brand-800 focus:outline-none focus:ring-4  focus:ring-brand-300 dark:bg-brand-600 dark:hover:bg-brand-700 dark:focus:ring-brand-800">
    ...
    <footer class="p-4 bg-white md:p-8 lg:p-10 dark:bg-gray-800">
        <div class="mx-auto max-w-screen-xl text-center">
            <a href="{{ route('home') }}"
                ...
                <img src="{{ asset('assets/images/cars/LOGO.jpg') }}" class="mr-1 h-32"
                    alt="Logo" />CarRental
            </a>
